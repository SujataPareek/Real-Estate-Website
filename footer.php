...
<footer class="footer">
   ...
   <section class="flex">
      ...
      <div class="box">
         ...
         <a href="binalsetia2255@gmail.com"><i class="fas fa-envelope"></i><span>binalsetia2255@gmail.com</span></a>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>binal</span> | all rights reserved!</div>
